...
[![Deploy](https://img.shields.io/badge/🚀-Deploy_Dokploy-5865F2?style=for-the-badge)](#deploy-dokploy)
...
[![Deploy](https://img.shields.io/badge/🚀_Deploy-cyan?style=flat-square)](#deploy-dokploy)
...
> 💡 **¿Vas a producción?** Deploy en **Dokploy con Nixpacks**: contenedor único con Lavalink incluido → [`🚀 Deploy`](#deploy-dokploy). Documentación completa en [`🛠️ Desarrollo Local`](#-desarrollo-local).
...
## 🚀 Deploy (guía genérica para Dokploy / VPS)

OmniBot corre en un solo contenedor gracias a **Nixpacks**, que descarga Lavalink + plugins al build. Esta es una guía genérica; cada operador despliega en su propia infraestructura.
...
- 💬 Discord OmniBot: *(link a completar en el lanzamiento)*
- 📘 Grupo Facebook (CLAUDE CODE): *(link a completar en el lanzamiento)*
